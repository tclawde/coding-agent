---
name: coding-agent
description: Run Codex CLI, Claude Code, OpenCode, Pi Coding Agent, or iFlow via background process for programmatic control.
metadata: {"openclaw":{"emoji":"🧩","requires":{"anyBins":["claude","codex","opencode","pi","iflow"]}}}
---
